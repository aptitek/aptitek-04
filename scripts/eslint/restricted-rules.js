  ...
  'error',
  {
    paths: [
      ...
      },
      {
        ...
        message: 'MUI is deprecated. Use Material Design 3 icons from @m3e/icons.',
      },
      {
        name: '@emotion/react',
        message: 'Emotion is prohibited. Use Panda CSS compile-time atomic styles.',
      },
      {
        name: '@emotion/styled',
        message: 'Emotion is prohibited. Use Panda CSS compile-time atomic styles.',
      },
      {
        ...
        message: 'Tailwind CSS is disallowed in favor of Material Design 3 tokens and Panda CSS.',
      },
      {
        name: 'tailwindcss',
        message: 'Tailwind CSS is disallowed in favor of Material Design 3 tokens and Panda CSS.',
    ...
    patterns: [
      {
        group: ['@mui/*'],
        message: 'MUI is deprecated in this ecosystem. Migrate to @m3e/react and Panda CSS.',
      },
      {
        group: ['@emotion/*'],
...
export const restrictedSyntaxRules = [
  ...
  {
    selector: 'CallExpression[callee.name="styled"][arguments.0.type="Literal"]',
    message:
  ...
  {
    selector: 'JSXElement > JSXExpressionContainer > Literal[value=/[a-zA-Z0-9]/]',
    message:
  ...
  // Rule 9: Prohibition of Text Content in Styles
  {
    ...
    message: 'Presentation layers must not declare textual content in CSS/styles.',
  },
